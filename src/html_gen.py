...
def generate_html(stats: dict):
    ...
    # Ссылки на файлы
    base = f"https://raw.githubusercontent.com/{GITHUB_USERNAME}/{GITHUB_REPO}/main/output"
    files = [
...
<div class="wrap">
  ...
  <footer>
    ...
    <a href="https://github.com/{GITHUB_USERNAME}/{GITHUB_REPO}" style="color:#6366f1">GitHub</a>
  </footer>
</div>
<script>
